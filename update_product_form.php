...
function validateForm() {
  ...
  if (name=="" || old_prices=="" || prices=="" || quantity=="" || view=="" || special=="" || description=="" || size=="" || iddm=="" || idee=="") {
          ...
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
              ...
              <form action="admin.php?act=updateform_product" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <label>Gender</label>
                    <select name="gender_product" required>
                      <option value="">Choose Gender</option>
                      <option value="Men" <?= ($result[0]['gender'] == 'Men') ? 'selected' : '' ?>>Men</option>
                      <option value="Women" <?= ($result[0]['gender'] == 'Women') ? 'selected' : '' ?>>Women</option>
                      <option value="Unisex" <?= ($result[0]['gender'] == 'Unisex') ? 'selected' : '' ?>>Unisex</option>
                    </select>
                    <label>Catalog</label>
                    <select name="iddm" id="">
                      <?php
