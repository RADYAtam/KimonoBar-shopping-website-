    ...
    switch ($_GET['act']) {
      ...
      case 'insert_product': {
          ...
          if (isset($_POST['submit'])) {
            ...
            $gender_pd = $_POST['gender_product'];
            //upload picture
            $target_dir = "../uploads/";
            ...
            if ($uploadOk == 1) {
              ...
              if ($existing_product) {
                ...
                if ($id_pd == 0) {
                  ...
                  insert_product($id_pd, $quantity_pd, $name_pd, $prices_pd, $img_pd, $id_ee, $oldprices_pd, $view_pd, $special_pd, $description_pd, $size_pd, $gender_pd);
                  $dmsp = getall_catalog();
                  $dmee = getall_user();
                  $kq = getall_product();
                  include("product.php");
      ...
      case 'updateform_product': {
          ...
          if (isset($_POST['id'])) {
            ...
            if ($flag_check_similar) {
              ...
              update_product($id, $quantity_pd, $id_pd, $name_pd, $prices_pd, $img_pd, $id_ee, $oldprices_pd, $view_pd, $special_pd, $description_pd, $size_pd, $gender_pd);
              $dmsp = getall_catalog();
              $dmee = getall_user();
              $kq = getall_product();
              include("product.php");
