...
<div class="axil-signin-area">
    ...
    <div class="signin-header">
        <div class="row align-items-center">
            <div class="col-sm-4">
                <a href="fashionApp.php" class="site-logo"><img src="../assets_kimono/imgs/logo1.png" alt="logo"></a>
            </div>
            <div class="col-sm-8">
                <div class="singin-header-btn">
                    <p>Not a member?</p>
                    <a href="fashionApp.php?act=insert_client_user&id='1'" class="axil-btn btn-bg-secondary sign-up-btn">Sign
                        Up Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 offset-xl-2">
            <div class="axil-signin-form-wrap">
                <div class="axil-signin-form">
                    <h3 class="title">Sign in to Kimono bar.</h3>
