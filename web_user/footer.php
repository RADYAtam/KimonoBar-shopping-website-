                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="axil-footer-widget">
                            ...
                            <a href="index.html">
                                <img class="light-logo" src="../assets_kimono/imgs/logo1.png" alt="Logo Images">
                            </a>
                        </div> -->
                            <div class="inner">
                                ...
                                <ul class="support-list-item">
                                    <li><a href="kimonobar@gmail.com"><i
                                                class="fal fa-envelope-open"></i>kimonobar@gmail.com</a></li>
                                    <li><a href="tel: 0789435521"><i class="fal fa-phone-alt"></i>
                                            0789435521</a></li>
...
<div class="col-lg-3 col-sm-6">
    <div class="axil-footer-widget">
        <div class="inner" style="text-align:center;">
            <img src="../assets/images/logo3.png" alt="card picture" style="max-width: 30px; ">
        </div>
    </div>
</div>
<!-- End Single Widget  -->
