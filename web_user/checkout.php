                                                ...
                                                <tbody>
                                                        ...
                                                        foreach($more_cart as $cart)
                                                        {
                                                            if($iddh == $cart['id_order'])
                                                            {
                                                                ...
                                                                <tr class="order-product">
                                                                    ...
                                                                    <td>'.$cart['size'].'</td>
                                                                    <td style="text-align:left;">'.number_format($cart['prices']).'MAD</td>
                                                                </tr>
                                                            ';
                                                            }
                                                        }
                                                            ...
                                                            <td colspan="2">
                                                                <div class="order-shipping" >
                                                                    <div class="shipping-amount">
                                                                        ...
                                                                        <span class="amount">0.00MAD</span>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                    ...
                                                    echo'
                                                                            <tr class="order-total">
                                                                                <td>Total</td>
                                                                                <td class="order-total-amount">'.number_format($total).'MAD</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
