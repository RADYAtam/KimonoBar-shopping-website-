                            ...
                            if(isset($_SESSION['cart'])&&(count($_SESSION['cart'])>0))
                            {
                                ...
                                foreach($_SESSION['cart'] as $item)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-price" data-title="Price"><span class="currency-symbol">'.number_format($item[3]).'MAD</span></td>
                                        <td class="product-price" data-title="quantity"><span class="currency-symbol">'.$item[4].'</span></td>
                                        <td class="product-subtotal" data-title="Subtotal"><span class="currency-symbol">'.number_format($total).'MAD</span></td>
                                    </tr>
                                    </tbody>
                                    ';
                                    $total_final +=$total;
                                ...
                                echo '
                                        ...
                                        <div class="cart-update-btn-area">
                                            ...
                                            <div class="update-btn">
                                                <a href="fashionApp.php" class="axil-btn btn-outline">Continuous Buy Product</a>
                                            </div>
                                        </div>
                                        <div class="row">
                                                        ...
                                                        <table class="table summery-table mb--30">
                                                            <tbody>
                                                                <tr class="order-subtotal">
                                                                    <td>Subtotal</td>
                                                                    <td>'.number_format($total_final).'MAD</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Shipping</td>
                                                                    <td>
                                                                        ...
                                                                        <label for="radio2">Local store: 000MAD</label>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr class="order-tax">
                                                                    <td>Tax</td>
                                                                    <td>'.number_format($tax).'MAD</td>
                                                                </tr>
                                                                <tr class="order-total">
                                                                    <td>Total</td>
                                                                    <td class="order-total-amount">'.number_format($total_final + $tax).'MAD</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
